        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2 flex justify-center animate-fade-in delay-500">
            <div className="relative group">
              {/* Main Photo Container with Round Mask */}
              <div className="relative w-96 h-96 bg-gradient-to-br from-orange-400 via-pink-500 to-purple-600 p-1 group-hover:scale-105 transition-all duration-500 rounded-full">
